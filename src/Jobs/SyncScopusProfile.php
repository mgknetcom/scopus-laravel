...
final class SyncScopusProfile implements ShouldBeUnique, ShouldQueue
{
    ...
    public function middleware(): array
    {
        return [
            ...
            (new WithoutOverlapping('scopus-profile-'.$this->profileId))->expireAfter(3600),
        ];
    }
    ...
    public function handle(ScopusIntegration $integration): void
    {
        ...
        if ($profile !== null) {
            try {
                $integration->syncProfile($profile);
